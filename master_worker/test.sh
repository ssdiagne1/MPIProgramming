...
do
    t=($test)
    ANSW=$(srun --partition=Centaurus --time=00:05:00 --ntasks=${t[1]} ./mpi_master_worker 1 0 10 ${t[0]} ${t[2]} 2> .time < /dev/null)
    ...
    then # success
        ...
        echo FAIL: "srun --partition=Centaurus --time=00:05:00 --ntasks=${t[1]} ./mpi_master_worker 1 0 10 ${t[0]} ${t[2]}" should give roughly "${t[3]}" not ${ANSW}
        exit 1
    fi
